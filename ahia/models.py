...
class Post(models.Model):
	...
	post_asset = models.ForeignKey(Asset, null=True,blank=True,on_delete=models.DO_NOTHING,)
...
class Chat(models.Model):
    chat_sender = models.ForeignKey(User, related_name="sender",on_delete=models.DO_NOTHING,)
    chat_receiver = models.ForeignKey(User, related_name="receiver",on_delete=models.DO_NOTHING,)
